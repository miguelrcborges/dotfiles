...
_G.packer_plugins = {
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/miguel/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["tokyonight.nvim"] = {
    loaded = true,
    path = "/home/miguel/.local/share/nvim/site/pack/packer/start/tokyonight.nvim",
    url = "https://github.com/folke/tokyonight.nvim"
  },
  ["wal.vim"] = {
    loaded = true,
    path = "/home/miguel/.local/share/nvim/site/pack/packer/start/wal.vim",
